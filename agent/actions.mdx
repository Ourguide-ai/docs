...
Actions are capabilities you enable for your agent. Go to the [Actions](https://dashboard.ourguide.ai/dashboard/tools/openapi) page in your dashboard to manage them.
