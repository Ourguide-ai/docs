...
| ----------------- | -------------------------------------------------- | --------- |
| `data-visibility` | Set to `"false"` to keep the widget hidden on load | Visible   |

| Property     | Description                          | Default |
| ------------ | ------------------------------------ | ------- |
| `visibility` | `true` shows the widget, `false` hides it | `true`  |

You can also set `visibility` in `window.ArgideSettings` before the script loads. It takes precedence over `data-visibility`.
