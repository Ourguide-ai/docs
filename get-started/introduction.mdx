...
<CardGroup cols={2}>
  ...
  <Card title="Ourguide Docs MCP" icon="robot" href="/get-started/ourguide-docs-mcp">
...
<Steps>
  ...
  <Step title="Integrate">
    Connect your API via [OpenAPI spec](/integration/openapi) or [MCP](/integration/mcp-servers).
  </Step>
  <Step title="Deploy">
