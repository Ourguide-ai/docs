...
1. In the [dashboard](https://dashboard.argide.ai/dashboard), open **Tools**
...
<CardGroup cols={2}>
  ...
  <Card title="Server-Side MCP Authentication" icon="key" href="/integration/server-side-mcp-auth">
