---
title: "MCP Servers"
description: "Give your agent access to MCP tools"
---

Give your Ourguide agent the ability to use tools from any MCP (Model Context Protocol) server. Once connected, your agent can call these tools to answer user questions and take actions.

<Info>
  **What are MCP tools?** MCP is an open standard that lets AI agents connect to external services. By adding an MCP server, your agent gains access to all tools that server exposes — no custom code required.
</Info>
