...
<Info>
  This is not your app's session JWT. It's an Ourguide-scoped identity token your backend mints with `OURGUIDE_VERIFICATION_SECRET`. See [Identity Verification](/setup/identity-verification).
</Info>
