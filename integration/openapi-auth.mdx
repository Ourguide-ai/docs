...
<Info>
  This is not your app's session JWT. It's an Argide-scoped identity token your backend mints with `ARGIDE_AUTH_SECRET`. See [Identity Verification](/setup/identity-verification).
</Info>
