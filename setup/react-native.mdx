...
| `apiUrl`        | No       | API URL (defaults to `https://dashboard.argide.ai`)         |
...
| Feature              | Web (`@argide/ui`)              | React Native (`@argide/react-native`)  |
| -------------------- | --------------------------------- | ---------------------------------------- |
...
| Provider             | `ArgideProvider` from `@argide/ui` | `ArgideProvider` from `@argide/react-native` |
