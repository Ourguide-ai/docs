...
In the [dashboard](https://dashboard.argide.ai/dashboard), open **Deploy → Install** and copy your embed code:
...
In the [dashboard](https://dashboard.argide.ai/dashboard), open **Deploy → Backend Integration** and copy **ARGIDE_AUTH_SECRET**. Use it to sign JWTs for [Identity Verification](/integration/identity-verification).
