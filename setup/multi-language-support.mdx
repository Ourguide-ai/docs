...
Pass a `language` prop to the widget and Argide handles the rest — the AI responds in that language and the welcome message is translated automatically.
...
2. Argide translates the welcome message on the fly
...
Argide supports the following ISO 639-1 codes:
